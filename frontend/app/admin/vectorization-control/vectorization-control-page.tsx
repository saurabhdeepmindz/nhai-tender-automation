...
export default function VectorizationControlPage() {
  ...
  const fetchStats = async () => {
    const response = await fetch(`${API_BASE_URL}/api/admin/vectorization/stats`, {
  ...
  const fetchQueries = async () => {
    const response = await fetch(
      `${API_BASE_URL}/api/admin/vectorization/queries?limit=100`,
      {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
      }
    );
  ...
  const fetchFailedQueries = async () => {
    const response = await fetch(`${API_BASE_URL}/api/vectorization/failures`, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
    });
    const data = await response.json();
  ...
  const fetchJobConfig = async () => {
    const response = await fetch(`${API_BASE_URL}/api/admin/vectorization/job/config`, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
    });
    const data = await response.json();
  ...
  const handleVectorizeQuery = async (queryId: string) => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/vectorization/query/${queryId}`,
        {
          method: 'POST',
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        }
  ...
  const handleBatchVectorize = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/vectorization/batch`, {
        method: 'POST',
        headers: {
  ...
  const handleRetryFailed = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/vectorization/retry-failures`,
        {
          method: 'POST',
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        }
  ...
  const handlePauseJob = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/admin/vectorization/job/pause`, {
        method: 'POST',
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
      });
      const data = await response.json();
  ...
  const handleResumeJob = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/admin/vectorization/job/resume`, {
        method: 'POST',
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
      });
      const data = await response.json();
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="font-semibold text-gray-900">
                {jobConfig?.schedule || 'Every 5 minutes'}
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
